...
class OrderMgmtAdminWidget extends StatefulWidget {
  ...
  @override
  _OrderMgmtAdminWidgetState createState() => _OrderMgmtAdminWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OrderCompletedRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrderCompletedRecord> orderMgmtAdminOrderCompletedRecordList =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
