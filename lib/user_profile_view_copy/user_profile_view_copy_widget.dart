...
class UserProfileViewCopyWidget extends StatefulWidget {
  ...
  @override
  _UserProfileViewCopyWidgetState createState() =>
      _UserProfileViewCopyWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final userProfileViewCopyUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            userProfileViewCopyUsersRecord.displayName!,
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  userProfileViewCopyUsersRecord.userBio,
                                  'Hello World',
                                ),
