...
import 'admin_channel_approval_list_model.dart';
export 'admin_channel_approval_list_model.dart';

class AdminChannelApprovalListWidget extends StatefulWidget {
  const AdminChannelApprovalListWidget({Key? key}) : super(key: key);

  @override
  _AdminChannelApprovalListWidgetState createState() =>
      _AdminChannelApprovalListWidgetState();
}

class _AdminChannelApprovalListWidgetState
    extends State<AdminChannelApprovalListWidget> {
  late AdminChannelApprovalListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminChannelApprovalListModel());
  }
