                                            ...
                                            Padding(
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  final textGetSatoshiResponse =
                                                      snapshot.data!;
                                                  return Text(
                                                    '10,000 Satoshi\'s = ${formatNumber(
                                                      functions.calcSatoshi(
                                                          GetSatoshiCall
                                                              .priceTHB(
                                                        textGetSatoshiResponse
                                                            .jsonBody,
                                                      ).toString()),
                                                      formatType:
                                                          FormatType.decimal,
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      if (valueOrDefault(
                                          ...
                                          'admin') {
                                        context
                                            .pushNamed('order_admin_mgmt_list');
                                      } else {
                                        context.pushNamed(
                                          'order_mgmt_list',
                                          queryParams: {
