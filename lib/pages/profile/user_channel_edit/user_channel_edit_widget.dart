...
import 'user_channel_edit_model.dart';
export 'user_channel_edit_model.dart';

class UserChannelEditWidget extends StatefulWidget {
  const UserChannelEditWidget({
    Key? key,
    this.channelRef,
  }) : super(key: key);
  ...
  @override
  _UserChannelEditWidgetState createState() => _UserChannelEditWidgetState();
}

class _UserChannelEditWidgetState extends State<UserChannelEditWidget> {
  late UserChannelEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserChannelEditModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ChannelsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final userChannelEditChannelsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                        ...
                                        text: userChannelEditChannelsRecord
                                            .channelName,
                                      ),
                                      autofocus: true,
                                      obscureText: false,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText:
                                          'Tell your audience more about you',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyText2
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
