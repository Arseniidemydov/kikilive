              ...
              children: [
                Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          if (valueOrDefault<bool>(
                              currentUserDocument?.userVerify, false))
                            AuthUserStreamWidget(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(15.0, 5.0, 20.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Expanded(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        if (valueOrDefault<bool>(
                                            currentUserDocument?.userVerify,
                                            false))
                                          AuthUserStreamWidget(
                            ...
                            AuthUserStreamWidget(
                              builder: (context) => Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () async {
                                      context.pushNamed('product_add_page');
                                    },
                                    child: Container(
                                      height: 40.0,
                                      decoration: BoxDecoration(
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemBuilder: (context, gridViewIndex) {
                                        ...
                                        return ProductCardWidget(
                                          key: Key(
                                              'Keyjy4_${gridViewIndex}_of_${gridViewProductsRecordList.length}'),
                                          productRef:
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed('seller_get_verified');
                              },
                              text: 'Get Verified',
                              options: FFButtonOptions(
                                width: 180.0,
