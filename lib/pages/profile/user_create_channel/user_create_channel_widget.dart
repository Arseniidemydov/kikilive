...
import 'user_create_channel_model.dart';
export 'user_create_channel_model.dart';

class UserCreateChannelWidget extends StatefulWidget {
  const UserCreateChannelWidget({Key? key}) : super(key: key);

  @override
  _UserCreateChannelWidgetState createState() =>
      _UserCreateChannelWidgetState();
}

class _UserCreateChannelWidgetState extends State<UserCreateChannelWidget> {
  late UserCreateChannelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserCreateChannelModel());
