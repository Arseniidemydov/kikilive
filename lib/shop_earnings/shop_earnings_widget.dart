  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OrdersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final shopEarningsOrdersRecord = shopEarningsOrdersRecordList.isNotEmpty
            ? shopEarningsOrdersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  functions.calcEarning(getCurrentTimestamp, containerOrdersRecordList.map((e) => e.productSubtotal).withoutNulls.toList(), containerOrdersRecordList.map((e) => e.orderDate).withoutNulls.toList()).toString(),
                                                                                  style: FlutterFlowTheme.of(context).bodyText1,
                                                                                ),
                                                                              ],
                                                                            ),
