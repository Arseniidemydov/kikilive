    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'category_image':
          ...
          break;
        case 'category_order':
          result.categoryOrder = serializers.deserialize(value,
...
class _$CategoryRecord extends CategoryRecord {
  ...
  _$CategoryRecord._(
      {this.categoryName, this.categoryImage, this.categoryOrder, this.ffRef})
      : super._();
...
class CategoryRecordBuilder
  ...
  set categoryOrder(int? categoryOrder) =>
      _$this._categoryOrder = categoryOrder;
